...
(def right-wall
  (union (key-wall-brace lastcol 0 0 1 web-post-tr lastcol 0 1 0 web-post-tr)
         (for [y (range 0 lastrow)]
           (key-wall-brace lastcol y 1 0 web-post-tr lastcol y 1 0 web-post-br))
         (for [y (range 1 lastrow)]
           (key-wall-brace lastcol (dec y) 1 0 web-post-br lastcol y 1 0 web-post-tr))
         (key-wall-brace lastcol cornerrow 0 -1 web-post-br
                         lastcol cornerrow 1 0 web-post-br)))
  ...
  (union
   ...
   (union
    (wall-brace thumb-tr-place 0 -1 thumb-post-br
                thumb-tr-place 0 -1 thumb-post-bl)
    (wall-brace thumb-tr-place 0 -1 thumb-post-bl
                thumb-tl-place 0 -1 thumb-post-br)
    (wall-brace thumb-tl-place 0 -1 thumb-post-br
                thumb-tl-place 0 -1 thumb-post-bl)
    (wall-brace thumb-tl-place 0 -1 thumb-post-bl
                thumb-ml-place 0 -1 thumb-post-br)
    (wall-brace thumb-ml-place 0 -1 thumb-post-br
                thumb-ml-place 0 -1 thumb-post-bl)
    (wall-brace thumb-ml-place -1  0 thumb-post-tl
                thumb-ml-place -1  0 thumb-post-bl))
   ; thumb corners
   (union
    (wall-brace thumb-ml-place -1  0 thumb-post-bl
                thumb-ml-place  0 -1 thumb-post-bl))
   ; thumb tweeners
   (wall-brace thumb-tr-place  0 -1 thumb-post-br
               (partial key-place 3 cornerrow)  0 -1 web-post-bl)
   ; clunky bit on the top left thumb connection  (normal connectors don't work well)
   (bottom-hull
    (left-key-place  cornerrow -1 (translate (wall-locate2 -1 0) web-post))
    (left-key-place  cornerrow -1 (translate (wall-locate3 -1 0) web-post))
    (thumb-ml-place (translate (wall-locate2 -1.01 -0.02) thumb-post-tl))
    (thumb-ml-place (translate (wall-locate3 -1.01 -0.02) thumb-post-tl)))
   (hull
   ...
   (hull
    ...
    (thumb-ml-place (translate (wall-locate1 -1.1 0) thumb-post-tl))
    (thumb-ml-place (translate (wall-locate2 -1.4 0) thumb-post-tl)))))
